...
public class PlayerDataSO : SavableSO
{
    ...
    private int chillicrop = 5;
    private int loofacrop = 5;
    private int eggplantcrop = 5;
    private int sweetpotatocrop = 5;
    private int papayacrop = 5;
    private int kalamansicrop = 5;
